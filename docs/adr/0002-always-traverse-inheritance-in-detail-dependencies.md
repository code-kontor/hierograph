...
**First applied in:** `detail_dependencies` ([spec](../tool-specifications/detail-level/cartograph-detail-dependencies-spec.md), implementation in `mcp-spike/core-app/.../DetailDependenciesMcpTool.java`)
...
- Specification: [`docs/tool-specifications/detail-level/cartograph-detail-dependencies-spec.md`](../tool-specifications/detail-level/cartograph-detail-dependencies-spec.md) — see *"Inheritance"* under *Semantics* and the *Per-edge fields* description of `from_parent` / `to_parent`.
