...
/**
 * Default implementation of {@link INodeMetadataProvider} for GraphDb-backed graphs.
 * Extracts "name" and "fqn" properties and determines kind from Neo4j labels.
 * Suitable for jQAssistant and JType schemas that share the same property conventions.
 */
public class DefaultNodeMetadataProvider implements INodeMetadataProvider {
